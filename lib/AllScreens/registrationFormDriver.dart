...
class RegistrationFormDriver extends StatelessWidget {
  static const String idScreen = "registrationFormDriver";
                    ...
                    child: IconButton(
                      onPressed: () {
                        Navigator.pushNamedAndRemoveUntil(
                            context, RegisterDriver.idScreen, (route) => false);
                      },
                      icon: Icon(
                        Icons.arrow_back,
                        size: 30.0,
                      ...
                      CustomButton(
                        ...
                        onPressed: () {
                          if (nameTextEditingController.text.length < 3) {
                            ...
                            displayToastMessage(
                                "Phone Number si mandatory", context);
                          } else if (phoneTextEditingController.text.length <
                              11) {
                            displayToastMessage(
                                "Number is incomplete.", context);
                        ...
                        FlatButton(
                          ...
                          onPressed: () {
                            Navigator.pushNamedAndRemoveUntil(context,
                                LoginScreenDriver.idScreen, (route) => false);
                          },
                        )
                      ],
  ...
  void registerNewUser(BuildContext context) async {
    ...
    if (firebaseUser != null) {
      ...
      Navigator.pushNamedAndRemoveUntil(
          context, CameraAuthScreen.idScreen, (route) => false);
    } else {
